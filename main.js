  ...
  data.map((x, y) => {
    ...
    <div id=${y}>
      ...
      <span class="options text-center">
        <i title="edit" onclick="editTask(this)" data-bs-toggle="modal" data-bs-target="#form" class="fas fa-edit"></i>
        <i title="delete" onclick="deleteTask(this);createTask()" class="fas fa-trash-alt"></i>
      </span>
    </div>
  `);
  });
